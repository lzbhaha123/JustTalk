...
namespace JustTalk.Clientsite
{
    ...
    class SocketClient
    {
        public delegate void ConfirmConnection(bool b);
        public event ConfirmConnection ConfirmConnectionEvent;
        private void SentConfirm(bool b) {
            ConfirmConnectionEvent(b);
        }
        ...
        public void StartClient(string url,string message)
        {
            // Connect to a remote device.  
            try
            {
                ...
                // Send test data to the remote device.  
                Send(client, InformationContainer.nickname+": "+message+"<EOF>");
                sendDone.WaitOne();
